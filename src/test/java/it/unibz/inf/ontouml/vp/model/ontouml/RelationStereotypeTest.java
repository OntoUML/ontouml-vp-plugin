...
class RelationStereotypeTest {
  ...
  void findRoleMixin() {
    assertThat(RelationStereotype.findByName("externalDependence"))
  ...
  void findEvent() {
    assertThat(RelationStereotype.findByName("componentOf"))
        .hasValue(RelationStereotype.COMPONENT_OF);
  }
