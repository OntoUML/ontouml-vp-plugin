...
class ProjectTest {
   ...
   @Test
   @DisplayName("setModel() should propagate the caller as the project of the all direct contents of the argument.")
   ...
   @Test
   @DisplayName("setModel() should propagate the caller as the project of the all direct/indirect contents of the argument.")
