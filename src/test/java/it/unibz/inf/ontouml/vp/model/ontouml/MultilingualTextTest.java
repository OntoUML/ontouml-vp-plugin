...
class MultilingualTextTest {
   ...
   @Test
   @DisplayName("If the requested language does not exist and there is no English text, getText() should retrieve text in the first available language (in alphabetical order)")
   ...
   @Test
   @DisplayName("If no language is specified, and there is no English text, getText() should retrieve text in the first available language (in alphabetical order)")
