...
public class OntoumlElementSerializer<T extends OntoumlElement> extends ElementSerializer<T> {
  ...
  public static void writeNullableIntegerField(
      String fieldName, Integer value, JsonGenerator jsonGen) throws IOException {

    if (value != null) jsonGen.writeNumberField(fieldName, value);
    else jsonGen.writeNullField(fieldName);
  }
