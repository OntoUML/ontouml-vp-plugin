...
public class SourceEnumeration {
	// each ArrayList is a set of permitted associations when the source is Enumeration
	...
	public static final Map<String, ArrayList<String>> allowedRelationsMap = new HashMap<String, ArrayList<String>>() {
		{
			...
			put(StereotypeUtils.STR_TYPE, new ArrayList<>());
