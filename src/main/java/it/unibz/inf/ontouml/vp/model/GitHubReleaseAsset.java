...
public class GitHubReleaseAsset {
	...
	final private static String PROP_NAME = "name";
	final private static String PROP_ID = "id";
	final private static String PROP_BROWSER_DOWNLOAD_URL = "browser_download_url";
	final private static String PROP_CONTENT_TYPE = "content_type";
	
	final private static String CONTENT_TYPE_APPLICATION_ZIP = "application/zip";
