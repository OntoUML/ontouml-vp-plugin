...
public class ModelListener implements PropertyChangeListener {
  ...
  public static final String PCN_MODEL_VIEW_ADDED = "modelViewAdded";
  // Events on classes
  public static final String PCN_STEREOTYPES = "stereotypes";
  public static final String PCN_RESTRICTED_TO = StereotypeUtils.PROPERTY_RESTRICTED_TO;
  public static final String PCN_FROM_RELATIONSHIP_ADDED = "fromRelationshipAdded";
  public static final String PCN_FROM_RELATIONSHIP_REMOVED = "fromRelationshipRemoved";
  public static final String PCN_TO_RELATIONSHIP_ADDED = "toRelationshipAdded";
  public static final String PCN_TO_RELATIONSHIP_REMOVED = "toRelationshipRemoved";
  // Events on generalizations
  public static final String PCN_FROM_MODEL = "fromModel";
  public static final String PCN_TO_MODEL = "toModel";

  private final Set<String> interestStereotypes;
  ...
  private void lookupAndPropagateRestrictedTo(Object classObject) {
    ...
    final String stereotype =
        _class != null ? StereotypeUtils.getUniqueStereotypeName(_class) : null;
