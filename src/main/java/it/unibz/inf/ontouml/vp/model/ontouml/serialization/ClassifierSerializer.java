...
public class ClassifierSerializer<T extends Classifier<T, S>, S extends Stereotype> extends DecoratableSerializer<T, S> {
   @Override
   public void serialize(T classifier, JsonGenerator jsonGen, SerializerProvider provider) throws IOException {
