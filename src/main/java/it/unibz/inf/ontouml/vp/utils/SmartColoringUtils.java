...
public class SmartColoringUtils {
   ...
   public static final Color LIGHT_GREEN = new Color(211, 255, 211);
   public static final Color PINK = new Color(255, 153, 163);
   public static final Color LIGHT_PINK = new Color(255, 218, 221);
   public static final Color BLUE = new Color(112, 215, 255);
   public static final Color LIGHT_BLUE = new Color(192, 237, 255);
   public static final Color WHITE = new Color(255, 255, 255);
   public static final Color YELLOW = new Color(252, 252, 212);
   public static final Color ORANGE = new Color(252, 224, 192);
   public static final Color PURPLE = new Color(211, 211, 252);
   public static final Color GREY = new Color(224, 224, 224);

   public static final Color COLOR_RELATOR = GREEN;
   public static final Color COLOR_RELATOR_ALTERNATIVE = LIGHT_GREEN;
   public static final Color COLOR_EXTRINSIC_MODE = GREEN;
   public static final Color COLOR_EXTRINSIC_MODE_ALTERNATIVE = LIGHT_GREEN;
   public static final Color COLOR_FUNCTIONAL_COMPLEX = PINK;
   public static final Color COLOR_FUNCTIONAL_COMPLEX_ALTERNATIVE = LIGHT_PINK;
   public static final Color COLOR_COLLECTIVE = PINK;
   public static final Color COLOR_COLLECTIVE_ALTERNATIVE = LIGHT_PINK;
   public static final Color COLOR_QUANTITY = PINK;
   public static final Color COLOR_QUANTITY_ALTERNATIVE = LIGHT_PINK;
   public static final Color COLOR_INTRINSIC_MODE = BLUE;
   public static final Color COLOR_INTRINSIC_MODE_ALTERNATIVE = LIGHT_BLUE;
   public static final Color COLOR_QUALITY = BLUE;
   public static final Color COLOR_QUALITY_ALTERNATIVE = LIGHT_BLUE;
   public static final Color COLOR_ABSTRACT = WHITE;
   public static final Color COLOR_EVENT = YELLOW;
   public static final Color COLOR_SITUATION = ORANGE;
   public static final Color COLOR_TYPE = PURPLE;
   public static final Color COLOR_NON_SPECIFIC = GREY;
   ...
   private static Color getColor(IClass _class) {
      ...
      final boolean isUltimateSortal = Stereotype.getUltimateSortalStereotypeNames().contains(stereotype);
