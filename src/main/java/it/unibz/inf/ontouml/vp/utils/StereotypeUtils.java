...
public class StereotypeUtils {
  ...
  public static Set<String> getOntoUMLStereotypeNames() {
    final Set<String> str_names = new HashSet<>();
  ...
  public static void generate() {
    ...
    for (String stereotypeName : taggedStereotypeNames) {
      ...
      if (stereotype.getName().equals(STR_COLLECTIVE)
      ...
      if (stereotype.getName().equals(STR_TYPE)
  ...
  public static String getRestrictions() {
    return getRestrictionsList().stream().sorted().collect(Collectors.joining(" "));
  }
  ...
  public static List<String> getRestrictionsList() {
    return Arrays.asList(
        ...
        RESTRICTED_TO_EVENT,
        RESTRICTED_TO_SITUATION,
        RESTRICTED_TO_MODE,
        RESTRICTED_TO_FUNCTIONAL_COMPLEX,
        RESTRICTED_TO_QUALITY,
        RESTRICTED_TO_QUANTITY,
        RESTRICTED_TO_RELATOR,
        RESTRICTED_TO_TYPE,
        RESTRICTED_TO_ABSTRACT);
  }
  ...
  public static boolean reapplyCurrentStereotype(IClass _class) {
    ...
    if (stereotype == null || !getOntoUMLClassStereotypeNames().contains(stereotype)) return false;
  ...
  public static void deleteTaggedValue(IModelElement element, String name) {
    ...
    if (container != null) {
      ITaggedValue[] taggedValues = container.toTaggedValueArray();
      for (ITaggedValue tv : taggedValues) {
        if (tv.getName().equals(name)) tv.delete();
      }
    }
  }
  ...
  public static IStereotype getStereotype(String stereotypeName) {
    ...
    if (stereotype == null && getOntoUMLStereotypeNames().contains(stereotypeName)) {
      generate();
