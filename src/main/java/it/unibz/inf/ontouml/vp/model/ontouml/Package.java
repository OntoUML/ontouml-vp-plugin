...
public class Package extends ModelElement implements ModelContainer {
   ...
   public Relation createRelation(String id, String name, RelationStereotype stereotype, Classifier<?, ?> source, Classifier<?, ?> target) {
      return addContent(new Relation(id, name, stereotype, source, target));
   }

   public <T extends Classifier<T, S>, S extends Stereotype> Generalization createGeneralization(Classifier<T, S> specific, Classifier<T, S> general) {
      return createGeneralization(null, specific, general);
   }

   public <T extends Classifier<T, S>, S extends Stereotype> Generalization createGeneralization(String id, Classifier<T, S> specific, Classifier<T, S> general) {
   ...
   public GeneralizationSet createGeneralizationSet(String name, Collection<Generalization> generalizations) {
      return createGeneralizationSet(null, name, null, generalizations);
   }

   public GeneralizationSet createGeneralizationSet(String name, Class categorizer, Collection<Generalization> generalizations) {
      return createGeneralizationSet(null, name, categorizer, generalizations);
   }

   public GeneralizationSet createGeneralizationSet(String id, String name, Class categorizer, Collection<Generalization> generalizations) {
