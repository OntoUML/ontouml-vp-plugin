	...
	public void performAction(VPAction action, VPContext context, ActionEvent event) {
		...
		switch (action.getActionId()) {
			case ActionIds.TYPE:
				...
				StereotypeUtils.setAllowed(element, addedStereotype, StereotypeUtils.toAllowedNaturesString(StereotypeUtils.ALLOWED_TYPE));
				break;
			case ActionIds.HISTORICAL_ROLE:
				addedStereotype = StereotypeUtils.STR_HISTORICAL_ROLE;
				StereotypeUtils.applyStereotype(element, addedStereotype);
				StereotypeUtils.setAllowed(element, addedStereotype, StereotypeUtils.toAllowedNaturesString());
				break;
			case ActionIds.EVENT:
				addedStereotype = StereotypeUtils.STR_EVENT;
				StereotypeUtils.applyStereotype(element, addedStereotype);
				StereotypeUtils.setAllowed(element, addedStereotype, StereotypeUtils.toAllowedNaturesString(StereotypeUtils.ALLOWED_EVENT));
				break;
			...
			case ActionIds.RELATOR:
				...
				StereotypeUtils.applyStereotype(element, addedStereotype);
				StereotypeUtils.setAllowed(element, addedStereotype, StereotypeUtils.toAllowedNaturesString(StereotypeUtils.ALLOWED_RELATOR));
				break;
			case ActionIds.QUANTITY:
				addedStereotype = StereotypeUtils.STR_QUANTITY;
				StereotypeUtils.applyStereotype(element, addedStereotype);
				StereotypeUtils.setAllowed(element, addedStereotype, StereotypeUtils.toAllowedNaturesString(StereotypeUtils.ALLOWED_QUANTITY));
				break;
			case ActionIds.QUALITY:
				addedStereotype = StereotypeUtils.STR_QUALITY;
				StereotypeUtils.applyStereotype(element, addedStereotype);
				StereotypeUtils.setAllowed(element, addedStereotype, StereotypeUtils.toAllowedNaturesString(StereotypeUtils.ALLOWED_QUALITY));
				break;
			...
			case ActionIds.MODE:
				...
				StereotypeUtils.applyStereotype(element, addedStereotype);
				StereotypeUtils.setAllowed(element, addedStereotype, StereotypeUtils.toAllowedNaturesString(StereotypeUtils.ALLOWED_MODE));
				break;
			...
			case ActionIds.KIND:
				...
				StereotypeUtils.applyStereotype(element, addedStereotype);
				StereotypeUtils.setAllowed(element, addedStereotype, StereotypeUtils.toAllowedNaturesString(StereotypeUtils.ALLOWED_OBJECT));
				break;
			case ActionIds.COLLECTIVE:
				addedStereotype = StereotypeUtils.STR_COLLECTIVE;
				StereotypeUtils.applyStereotype(element, addedStereotype);
				StereotypeUtils.setAllowed(element, addedStereotype, StereotypeUtils.toAllowedNaturesString(StereotypeUtils.ALLOWED_COLLECTIVE));
				break;
