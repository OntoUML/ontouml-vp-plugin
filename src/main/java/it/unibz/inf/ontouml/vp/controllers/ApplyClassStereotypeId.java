...
public enum ApplyClassStereotypeId {
  ...
  ENUMERATION(
      "it.unibz.inf.ontouml.vp.addEnumerationStereotype", Stereotype.ENUMERATION, "Enumeration"),
  ...
  PHASE_MIXIN(
      "it.unibz.inf.ontouml.vp.addPhaseMixinStereotype", Stereotype.PHASE_MIXIN, "PhaseMixin"),
  ...
  COLLECTIVE(
      "it.unibz.inf.ontouml.vp.addCollectiveStereotype", Stereotype.COLLECTIVE, "Collective"),
  ...
  ENUMERATION_FIXED(
      ...
      "Enumeration"),
  DATATYPE_FIXED(
      "it.unibz.inf.ontouml.vp.addDatatypeStereotype.fixedMenu", Stereotype.DATATYPE, "Datatype"),
  ABSTRACT_FIXED(
      "it.unibz.inf.ontouml.vp.addAbstractStereotype.fixedMenu", Stereotype.ABSTRACT, "Abstract"),
  SUBKIND_FIXED(
      "it.unibz.inf.ontouml.vp.addSubkindStereotype.fixedMenu", Stereotype.SUBKIND, "Subkind"),
  ROLE_MIXIN_FIXED(
      "it.unibz.inf.ontouml.vp.addRoleMixinStereotype.fixedMenu", Stereotype.ROLE_MIXIN, "Role"),
  ROLE_FIXED("it.unibz.inf.ontouml.vp.addRoleStereotype.fixedMenu", Stereotype.ROLE, "RoleMixin"),
  RELATOR_FIXED(
      "it.unibz.inf.ontouml.vp.addRelatorStereotype.fixedMenu", Stereotype.RELATOR, "Relator"),
  QUANTITY_FIXED(
      "it.unibz.inf.ontouml.vp.addQuantityStereotype.fixedMenu", Stereotype.QUANTITY, "Quantity"),
  QUALITY_FIXED(
      "it.unibz.inf.ontouml.vp.addQualityStereotype.fixedMenu", Stereotype.QUALITY, "Quality"),
  PHASE_MIXIN_FIXED(
  ...
  COLLECTIVE_FIXED(
      ...
      "Collective"),
  CATEGORY_FIXED(
      "it.unibz.inf.ontouml.vp.addCategoryStereotype.fixedMenu", Stereotype.CATEGORY, "Category");
  ...
  public static ApplyClassStereotypeId getFromActionId(String actionId) {
    if (actionIdMap == null || actionIdMap.isEmpty()) {
      ...
      Arrays.stream(ApplyClassStereotypeId.values())
          .forEach(
              applyClassStereotypeId ->
                  actionIdMap.put(applyClassStereotypeId.getActionId(), applyClassStereotypeId));
    }
  ...
  public boolean hasKnownNature() {
    Set<?> knownNatureStereotypeActions =
        Set.of(
            TYPE,
            TYPE_FIXED,
            EVENT,
