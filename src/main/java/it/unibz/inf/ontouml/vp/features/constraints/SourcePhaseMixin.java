	...
	public static final Map<String, ArrayList<String>> allowedRelationsMap = new HashMap<String, ArrayList<String>>() {
		{
			...
			put(StereotypeUtils.STR_TYPE, new ArrayList<>(Arrays.asList(ActionIds.CHARACTERIZATION, ActionIds.COMPARATIVE, ActionIds.EXTERNAL_DEPENDENCE, ActionIds.MATERIAL, ActionIds.MEDIATION, ActionIds.PHASE_MIXIN)));
