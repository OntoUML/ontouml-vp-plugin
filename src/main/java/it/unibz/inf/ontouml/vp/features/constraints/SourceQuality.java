...
public class SourceQuality {
	...
	public static final ArrayList<String> targetType = new ArrayList<>(Arrays.asList(ActionIds.CHARACTERIZATION, ActionIds.COMPARATIVE, ActionIds.EXTERNAL_DEPENDENCE, ActionIds.MATERIAL, ActionIds.HISTORICAL_DEPENDENCE, ActionIds.INSTANTIATION));
