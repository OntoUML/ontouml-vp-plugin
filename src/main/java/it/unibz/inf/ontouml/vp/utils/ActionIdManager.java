...
public final class ActionIdManager {
  ...
  public static final String HISTORICAL_ROLE =
      "it.unibz.inf.ontouml.vp.addHistoricalRoleStereotype";
  public static final String HISTORICAL_ROLE_MIXIN =
      "it.unibz.inf.ontouml.vp.addHistoricalRoleMixinStereotype";
  ...
  public static final String PARTICIPATIONAL =
  ...
  public static final String HISTORICAL_DEPENDENCE =
  ...
  public static final String SUB_COLLECTION_OF =
  ...
  public static final String EXTERNAL_DEPENDENCE =
  ...
  public static final String CHARACTERIZATION =
  ...
  public static final String HISTORICAL_ROLE_FIXED =
      "it.unibz.inf.ontouml.vp.addHistoricalRoleStereotype.fixedMenu";
  public static final String HISTORICAL_ROLE_MIXIN_FIXED =
      "it.unibz.inf.ontouml.vp.addHistoricalRoleMixinStereotype.fixedMenu";
  public static final String EVENT_FIXED = "it.unibz.inf.ontouml.vp.addEventStereotype.fixedMenu";
  public static final String SITUATION_FIXED =
      "it.unibz.inf.ontouml.vp.addSituationStereotype.fixedMenu";

  public static final String ENUMERATION_FIXED =
      "it.unibz.inf.ontouml.vp.addEnumerationStereotype.fixedMenu";
  public static final String DATATYPE_FIXED =
      "it.unibz.inf.ontouml.vp.addDatatypeStereotype.fixedMenu";
  public static final String ABSTRACT_FIXED =
      "it.unibz.inf.ontouml.vp.addAbstractStereotype.fixedMenu";

  public static final String SUBKIND_FIXED =
      "it.unibz.inf.ontouml.vp.addSubkindStereotype.fixedMenu";
  public static final String ROLE_MIXIN_FIXED =
      "it.unibz.inf.ontouml.vp.addRoleMixinStereotype.fixedMenu";
  public static final String ROLE_FIXED = "it.unibz.inf.ontouml.vp.addRoleStereotype.fixedMenu";
  public static final String RELATOR_FIXED =
      "it.unibz.inf.ontouml.vp.addRelatorStereotype.fixedMenu";
  public static final String QUANTITY_FIXED =
      "it.unibz.inf.ontouml.vp.addQuantityStereotype.fixedMenu";
  public static final String QUALITY_FIXED =
      "it.unibz.inf.ontouml.vp.addQualityStereotype.fixedMenu";
  public static final String PHASE_MIXIN_FIXED =
      "it.unibz.inf.ontouml.vp.addPhaseMixinStereotype.fixedMenu";
  ...
  public static final String COLLECTIVE_FIXED =
      "it.unibz.inf.ontouml.vp.addCollectiveStereotype.fixedMenu";
  public static final String CATEGORY_FIXED =
      "it.unibz.inf.ontouml.vp.addCategoryStereotype.fixedMenu";

  // Association stereotypes (ordered as in plugin.xml)
  public static final String INSTANTIATION_FIXED =
      "it.unibz.inf.ontouml.vp.addInstantiationStereotype.fixedMenu";

  public static final String TERMINATION_FIXED =
      "it.unibz.inf.ontouml.vp.addTerminationStereotype.fixedMenu";
  public static final String PARTICIPATIONAL_FIXED =
      "it.unibz.inf.ontouml.vp.addParticipationalStereotype.fixedMenu";
  public static final String PARTICIPATION_FIXED =
      "it.unibz.inf.ontouml.vp.addParticipationStereotype.fixedMenu";
  public static final String HISTORICAL_DEPENDENCE_FIXED =
      "it.unibz.inf.ontouml.vp.addHistoricalDependenceStereotype.fixedMenu";
  public static final String CREATION_FIXED =
      "it.unibz.inf.ontouml.vp.addCreationStereotype.fixedMenu";
  public static final String MANIFESTATION_FIXED =
      "it.unibz.inf.ontouml.vp.addManifestationStereotype.fixedMenu";

  public static final String BRINGS_ABOUT_FIXED =
      "it.unibz.inf.ontouml.vp.addBringsStereotype.fixedMenu";
  public static final String TRIGGERS_FIXED =
      "it.unibz.inf.ontouml.vp.addTriggersStereotype.fixedMenu";

  public static final String SUB_QUANTITY_OF_FIXED =
      "it.unibz.inf.ontouml.vp.addSubQuantityStereotype.fixedMenu";
  public static final String SUB_COLLECTION_OF_FIXED =
      "it.unibz.inf.ontouml.vp.addSubCollectionStereotype.fixedMenu";
  public static final String MEMBER_OF_FIXED =
      "it.unibz.inf.ontouml.vp.addMemberOfStereotype.fixedMenu";
  public static final String MEDIATION_FIXED =
      "it.unibz.inf.ontouml.vp.addMediationStereotype.fixedMenu";
  public static final String MATERIAL_FIXED =
      "it.unibz.inf.ontouml.vp.addMaterialStereotype.fixedMenu";
  public static final String EXTERNAL_DEPENDENCE_FIXED =
      "it.unibz.inf.ontouml.vp.addExternalDependenceStereotype.fixedMenu";
  public static final String COMPONENT_OF_FIXED =
      "it.unibz.inf.ontouml.vp.addComponentOfStereotype.fixedMenu";
  public static final String COMPARATIVE_FIXED =
      "it.unibz.inf.ontouml.vp.addComparativeStereotype.fixedMenu";
  public static final String CHARACTERIZATION_FIXED =
  ...
  public static final String CLASS_PROPERTY_SET_RESTRICTED_TO =
      "it.unibz.inf.ontouml.vp.ClassProperties.restrictedTo";
  public static final String CLASS_PROPERTY_SET_IS_EXTENSIONAL =
      "it.unibz.inf.ontouml.vp.ClassProperties.isExtensional";
  public static final String CLASS_PROPERTY_SET_IS_DERIVED =
      "it.unibz.inf.ontouml.vp.ClassProperties.isDerived";
  public static final String CLASS_PROPERTY_SET_IS_ABSTRACT =
      "it.unibz.inf.ontouml.vp.ClassProperties.isAbstract";
  public static final String CLASS_PROPERTY_SET_IS_POWERTYPE =
      "it.unibz.inf.ontouml.vp.ClassProperties.isPowertype";
  public static final String CLASS_PROPERTY_SET_ORDER =
      "it.unibz.inf.ontouml.vp.ClassProperties.order";

  public static final String ASSOCIATION_PROPERTY_REVERSE_ASSOCIATION =
      "it.unibz.inf.ontouml.vp.AssociationProperties.reverseAssociation";
  public static final String ASSOCIATION_PROPERTY_SET_IS_ABSTRACT =
      "it.unibz.inf.ontouml.vp.AssociationProperties.isAbstract";
  public static final String ASSOCIATION_PROPERTY_SET_IS_DERIVED =
      "it.unibz.inf.ontouml.vp.AssociationProperties.isDerived";
  public static final String ASSOCIATION_PROPERTY_SOURCE_SET_IS_DERIVED =
      "it.unibz.inf.ontouml.vp.AssociationProperties.Source.isDerived";
  public static final String ASSOCIATION_PROPERTY_SOURCE_SET_IS_ORDERED =
      "it.unibz.inf.ontouml.vp.AssociationProperties.Source.isOrdered";
  public static final String ASSOCIATION_PROPERTY_SOURCE_SET_IS_READ_ONLY =
      "it.unibz.inf.ontouml.vp.AssociationProperties.Source.isReadOnly";
  public static final String ASSOCIATION_PROPERTY_TARGET_SET_IS_DERIVED =
      "it.unibz.inf.ontouml.vp.AssociationProperties.Target.isDerived";
  public static final String ASSOCIATION_PROPERTY_TARGET_SET_IS_ORDERED =
      "it.unibz.inf.ontouml.vp.AssociationProperties.Target.isOrdered";
  public static final String ASSOCIATION_PROPERTY_TARGET_SET_IS_READ_ONLY =
      "it.unibz.inf.ontouml.vp.AssociationProperties.Target.isReadOnly";

  public static final String ATTRIBUTE_PROPERTY_SET_IS_DERIVED =
      "it.unibz.inf.ontouml.vp.AttributeProperties.isDerived";
  public static final String ATTRIBUTE_PROPERTY_SET_IS_ORDERED =
      "it.unibz.inf.ontouml.vp.AttributeProperties.isOrdered";
  public static final String ATTRIBUTE_PROPERTY_SET_IS_READ_ONLY =
      "it.unibz.inf.ontouml.vp.AttributeProperties.isReadOnly";
