...
public class Stereotype {
   ...
   public static List<String> getOntoUMLClassStereotypeNames() {
      return new ArrayList<>(Arrays.asList(TYPE, HISTORICAL_ROLE, HISTORICAL_ROLE_MIXIN,
              EVENT, SITUATION, ENUMERATION, DATATYPE, ABSTRACT, CATEGORY,
              MIXIN, ROLE_MIXIN, PHASE_MIXIN, KIND, COLLECTIVE, QUANTITY,
              RELATOR, QUALITY, MODE, SUBKIND, ROLE, PHASE));
   }

   public static List<String> getOntoUMLAssociationStereotypeNames() {
      return new ArrayList<>(Arrays.asList(INSTANTIATION, TERMINATION, PARTICIPATIONAL, PARTICIPATION,
              HISTORICAL_DEPENDENCE, CREATION, MANIFESTATION, BRINGS_ABOUT, TRIGGERS,
              MATERIAL, MEDIATION, COMPARATIVE, CHARACTERIZATION, EXTERNAL_DEPENDENCE,
              COMPONENT_OF, MEMBER_OF, SUB_COLLECTION_OF, SUB_QUANTITY_OF));
   }
