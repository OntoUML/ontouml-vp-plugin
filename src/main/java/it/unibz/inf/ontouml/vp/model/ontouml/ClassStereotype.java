...
public enum ClassStereotype implements Stereotype {
  ...
  public static final Collection<ClassStereotype> SORTALS =
      Set.of(
          KIND,
          QUANTITY,
          COLLECTIVE,
          ...
          ROLE,
          HISTORICAL_ROLE);
  public static final Collection<ClassStereotype> ULTIMATE_SORTALS =
      Set.of(KIND, QUANTITY, COLLECTIVE, RELATOR, QUALITY, MODE);
  public static final Collection<ClassStereotype> BASE_SORTALS =
      Set.of(SUBKIND, PHASE, ROLE, HISTORICAL_ROLE);
  public static final Collection<ClassStereotype> NON_SORTALS =
      Set.of(CATEGORY, MIXIN, PHASE_MIXIN, ROLE_MIXIN, HISTORICAL_ROLE_MIXIN);
  public static final Collection<ClassStereotype> RIGIDS =
      Set.of(
          KIND,
          QUANTITY,
          COLLECTIVE,
          ...
          DATATYPE,
          ENUMERATION);
  public static final Collection<ClassStereotype> ANTI_RIGIDS =
      Set.of(ROLE, ROLE_MIXIN, PHASE, PHASE_MIXIN, HISTORICAL_ROLE, HISTORICAL_ROLE_MIXIN);
  ...
  public static final Collection<ClassStereotype> ENDURANTS =
      Set.of(
          KIND,
          QUANTITY,
          COLLECTIVE,
  ...
  public static final Collection<ClassStereotype> ABSTRACTS =
      Set.of(ABSTRACT, DATATYPE, ENUMERATION);
