...
public enum ClassStereotype implements Stereotype {
  ...
  public static List<ClassStereotype> SORTALS =
      Arrays.asList(
          KIND,
          QUANTITY,
          COLLECTIVE,
          ...
          ROLE,
          HISTORICAL_ROLE);
  public static List<ClassStereotype> ULTIMATE_SORTALS =
      Arrays.asList(KIND, QUANTITY, COLLECTIVE, RELATOR, QUALITY, MODE);
  public static List<ClassStereotype> BASE_SORTALS =
      Arrays.asList(SUBKIND, PHASE, ROLE, HISTORICAL_ROLE);
  public static List<ClassStereotype> NON_SORTALS =
      Arrays.asList(CATEGORY, MIXIN, PHASE_MIXIN, ROLE_MIXIN, HISTORICAL_ROLE_MIXIN);
  public static List<ClassStereotype> RIGIDS =
      Arrays.asList(
          KIND,
          QUANTITY,
          COLLECTIVE,
          ...
          DATATYPE,
          ENUMERATION);
  public static List<ClassStereotype> ANTI_RIGIDS =
      Arrays.asList(ROLE, ROLE_MIXIN, PHASE, PHASE_MIXIN, HISTORICAL_ROLE, HISTORICAL_ROLE_MIXIN);
  ...
  public static List<ClassStereotype> ENDURANTS =
      Arrays.asList(
          KIND,
          QUANTITY,
          COLLECTIVE,
