...
public class ClassEventManager extends ModelElementEventManager {
  ...
  private static final String RESTRICTED_TO_CHANGE_EVENT = StereotypesManager.PROPERTY_RESTRICTED_TO;
  private static final String IS_EXTENSIONAL_CHANGE_EVENT = StereotypesManager.PROPERTY_IS_EXTENSIONAL;
  ...
  private void enforceAndPropagateRestrictedTo() {
    ...
    if (!Class.doesItHaveFixedRestrictions(source) && !Class.doesItInheritItsRestrictions(source)
