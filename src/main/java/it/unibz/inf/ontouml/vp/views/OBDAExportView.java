...
public class OBDAExportView extends javax.swing.JPanel {
  ...
  private void initComponents() {
    ...
    panSchemaParams.setBorder(
        javax.swing.BorderFactory.createTitledBorder("Parameters for relational schema: "));
        ...
        jPanel4Layout
            ...
            .addGroup(
                ...
                jPanel4Layout
                    ...
                    .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                    .addComponent(
                        diagramPanel, javax.swing.GroupLayout.DEFAULT_SIZE, 125, Short.MAX_VALUE)
                    .addContainerGap()));
    ...
    jbtnGenerateFiles.addActionListener(
  ...
  private void jbtnGenerateFilesActionPerformed(java.awt.event.ActionEvent evt) {
    ...
    if (jcbGenerateConnection.isSelected()
      ...
      JOptionPane.showMessageDialog(
          null,
          "Host, database, user and password must be filled in.",
          "Error",
          JOptionPane.ERROR_MESSAGE);
      return;
    }

    if ((DBMSSuported) cbxDBMS.getSelectedItem() == DBMSSuported.GENERIC_SCHEMA
        && jcbGenerateConnection.isSelected()) {
      JOptionPane.showMessageDialog(
          null,
          "It is not possible to generate the connection file for the generic database.",
          "Error",
          JOptionPane.ERROR_MESSAGE);
      return;
    }
  ...
  private void updateComponentsValues() {
    ...
    if (configurations.getMappingStrategy() == MappingStrategy.ONE_TABLE_PER_KIND)
      rbtOntTablePerKind.setSelected(true);
    else rbtOneTablePerClass.setSelected(true);
