...
//
//			if (element == null || !IModelElementFactory.MODEL_TYPE_ASSOCIATION.equals(element.getModelType())) {
//				continue;
//			}
//
...
//			IAssociationUIModel reverseAssociationView = (IAssociationUIModel) dm.createConnector(diagram, association, originalAssociationView.getToShape(),
...
//			IConnectorUIModel reverseAssociationView = (IConnectorUIModel) dm.createDiagramElement(diagram, association);
