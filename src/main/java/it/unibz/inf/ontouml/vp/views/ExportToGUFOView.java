...
//		defaultTableModel_table2 = new DefaultTableModel(data_table2, columnNamesArr_table2);
      ...
      addButton_table2.addActionListener(actionEvent -> {
         Vector<String> rowData = new Vector<>();
      ...
      deleteButton_table2.addActionListener(actionEvent -> {
         // Vector<?> rowData = null;
   ...
   private static String[] getLanguagesCode() {
      ...
      return new String[]{"default", "aa", "ab", "ae", "af", "ak", "am", "an", "ar", "as", "av", "ay", "az", "ba",
   ...
   public String getTablePackageMapping() {
      ...
      for (int row = 0; row < table2.getRowCount(); row++) {
         ...
         for (IModelElement element : packagesMapping) {
            ...
            if (element.getName().equals(packages))
